<script lang="ts">
  import { Folders } from 'phosphor-svelte';
</script>
...
<div class="space-y-6">
  <div class="flex items-center gap-3">
    ...
    <div>
      ...
      <p class="text-sm text-muted-foreground">Track your builds and project memory</p>
    </div>
  </div>
  <div class="rounded-xl border border-dashed border-border bg-card/50 p-12 text-center">
    <p class="text-muted-foreground">Your projects and their timelines will appear here.</p>
  </div>
</div>
